...
class ExampleServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetUser = channel.unary_unary(
                '/example.ExampleService/GetUser',
        ...
        self.CreateUser = channel.unary_unary(
                '/example.ExampleService/CreateUser',
        ...
        self.UpdateUser = channel.unary_unary(
                '/example.ExampleService/UpdateUser',
        ...
        self.DeleteUser = channel.unary_unary(
                '/example.ExampleService/DeleteUser',
        ...
        self.ListUsers = channel.unary_unary(
                '/example.ExampleService/ListUsers',
                request_serializer=example__pb2.ListUsersRequest.SerializeToString,
                response_deserializer=example__pb2.ListUsersResponse.FromString,
                _registered_method=True)
...
def add_ExampleServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ListUsers': grpc.unary_unary_rpc_method_handler(
                    servicer.ListUsers,
                    request_deserializer=example__pb2.ListUsersRequest.FromString,
                    response_serializer=example__pb2.ListUsersResponse.SerializeToString,
            ),
    }
...
class ExampleService(object):
    ...
    def ListUsers(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/example.ExampleService/ListUsers',
            example__pb2.ListUsersRequest.SerializeToString,
            example__pb2.ListUsersResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
